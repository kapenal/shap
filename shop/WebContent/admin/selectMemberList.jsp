...
<%
		...
		if(currentPage > 1){
%>
			<a class="btn btn-info" href="./selectMemberList.jsp?currentPage=<%=currentPage-1%>">이전</a>
<%
		}
		//다음 버튼
		...
		if(endPage < lastPage){
%>
		<a class="btn btn-info" href="./selectMemberList.jsp?currentPage=<%=currentPage+1%>">다음</a>
<%
		}
%>
	</div>
